...
#define STEEMIT_INIT_PUBLIC_KEY_STR             "GTN5xS5wtZu4k91ZpPjgzU5ULb3JikDEaxzPAmHn65Hz1gbSkpU5C"
#define STEEMIT_CHAIN_ID                        (fc::sha256::hash("wikiinvestigation"))

#define VESTS_SYMBOL  (uint64_t(6) | (uint64_t('V') << 8) | (uint64_t('E') << 16) | (uint64_t('S') << 24) | (uint64_t('T') << 32) | (uint64_t('S') << 40)) ///< VESTS with 6 digits of precision
#define STEEM_SYMBOL  (uint64_t(3) | (uint64_t('G') << 8) | (uint64_t('A') << 16) | (uint64_t('L') << 24) | (uint64_t('T') << 32) | (uint64_t('O') << 40) | (uint64_t('N') << 48)) ///< STEEM with 3 digits of precision
#define SBD_SYMBOL    (uint64_t(3) | (uint64_t('G') << 8) | (uint64_t('B') << 16) | (uint64_t('D') << 24) ) ///< STEEM Backed Dollars with 3 digits of precision
#define STMD_SYMBOL   (uint64_t(3) | (uint64_t('G') << 8) | (uint64_t('N') << 16) | (uint64_t('M') << 24) | (uint64_t('D') << 32) ) ///< STEEM Dollars with 3 digits of precision
#define STEEMIT_SYMBOL                          "GALTON"
#define STEEMIT_ADDRESS_PREFIX                  "GTN"
...
#define STEEMIT_VOTE_DUST_THRESHOLD             (50000)
